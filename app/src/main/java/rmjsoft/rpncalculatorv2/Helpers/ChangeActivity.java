package rmjsoft.rpncalculatorv2.Helpers;

/**
 * Created by RODIE on 19-Oct-17.
 */
 ...
 */
public class ChangeActivity implements OnClickListener {

    private Activity _source;
    private Class<?> _destination;
    private boolean _finishActivity;

    public ChangeActivity(Activity source, Class<?> destination) {
        super();
        _source = source;
    ...
    public ChangeActivity(Activity source, Class<?> destination, boolean finishActivity) {
